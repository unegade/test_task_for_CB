...
from lib.locators import CBRPageLocators, CBRReceptionPageLocators, CBRReceptionPageMessageLocators, CBRAboutWarningPageLocators


class CBRPage(BasePage):
    def check_is_cbr_page(self) -> bool:
        return CBRPageLocators.BASE_ADDRESS in self.browser.current_url
